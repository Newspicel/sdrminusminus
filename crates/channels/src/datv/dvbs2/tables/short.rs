// Parity accumulator addresses from ETSI EN 302 307-1 annex B: one row per group of 360
// information bits, each entry an address in the parity accumulator.

pub static R11_45: [&[u16]; 11] = [
...
pub static R4_15: [&[u16]; 12] = [
    &[
        1953, 2331, 2545, 2623, 4653, 5012, 5700, 6458, 6875, 7605, 7694, 7881, 8416, 8758, 9181,
        9555, 9578, 9932, 10068, 11479, 11699,
    ],
    &[
        514, 784, 2059, 2129, 2386, 2454, 3396, 5184, 6624, 6825, 7533, 7861, 9116, 9473, 9601,
        10432, 11011, 11159, 11378, 11528, 11598,
    ],
    &[
        483, 1303, 1735, 2291, 3302, 3648, 4222, 4522, 5511, 6626, 6804, 7404, 7752, 7982, 8108,
        8930, 9151, 9793, 9876, 10786, 11879,
    ],
    &[1956, 7572, 9020, 9971],
    &[13, 1578, 7445, 8373],
