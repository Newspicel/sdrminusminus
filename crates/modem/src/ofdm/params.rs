...
//! pilot subcarriers, which is 802.11a/g's geometry.
//!
...
///
/// [`Domain::RealHermitian`] is the DMT flag — a Hermitian-symmetry flag yields
/// real-baseband DMT from the same engine — and it is deliberately a *transmitter*
...
impl OfdmParams {
    ...
    /// The catalog's reference configuration: a 64-point transform with
