...
pub use fec::{
    ...
    conv::Viterbi5,
    crc4_msb, crc8_msb, crc16_ccitt, crc16_msb, crc16_msb_bits, crc16_x25, ermes_bch_decode,
    ermes_bch_encode, golay23_correct, golay23_encode, golay23_ok, hdlc_fcs_ok, lfsr_digest8,
    lfsr_digest8_reflect, mode_s_append_overlaid_parity, mode_s_append_parity,
