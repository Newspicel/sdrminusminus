...
fn ports_for(kind: &str) -> Vec<PortSpec> {
    ...
    match kind {
        ...
        "gps" => vec![PortSpec::new("position", Position, Out, true, Always)],
        "channel" => vec![
            PortSpec::new("iq", Iq, In, false, Always),
            PortSpec::new("position", Position, In, false, ChannelNeedsPosition),
        ...
        "scope" => vec![PortSpec::new("iq", Iq, In, false, Always)],
        "recorder" => vec![
            PortSpec::new("iq", Iq, In, false, Always),
            PortSpec::new("position", Position, In, false, Always),
        ],
        ...
        "map" => vec![
            PortSpec::new("events", Events, In, true, Always),
            PortSpec::new("position", Position, In, true, Always),
        ],
