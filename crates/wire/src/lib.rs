...
pub use channel::{
    ...
    DstarParams, DvbtBandwidth, DvbtParams, DvbtStandard, ErmesParams, FlexParams, FreeDvMode,
    FreeDvParams, GnssParams, HfdlParams, IdentParams, IlsComponent, IlsParams, InmarsatAeroParams,
