...
pub use channel::{
    ...
    DabMode, DabParams, DatvParams, DatvStandard, DmrParams, DmrSlots, DpmrParams, DrmMode,
    DrmParams, DstarParams, IdentParams, M17Params, MAX_IDENT_BANDWIDTH_HZ, MAX_IDENT_INTERVAL_MS,
    ...
    PocsagBaud, PocsagParams, RttyParams, RttyStopBits, Sideband, SsbParams, SubghzModulation,
...
pub use decode::{
    ...
    DvTrunkProtocol, IdentFeatures, IdentReport, Modulation, MorseText, NavtexMessage,
    PocsagMessage, PocsagPayload, ProtocolMatch, RdsUpdate, RttyText, SubghzEncoding, SubghzFrame,
...
mod contract_tests {
    ...
    fn decoder_params_default_from_empty_settings() {
        use channel::{
            ...
            MorseParams, NavtexParams, PocsagParams, RttyParams, SubghzParams,
        };
        for (json, expected) in [
            (
