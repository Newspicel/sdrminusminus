...
pub use workspace::{
    ...
    PatchRefusal, UpdateWorkspaceRequest, WORKSPACE_EXPORT_VERSION, WORKSPACE_SNAPSHOT_VERSION,
    WorkspaceDetail, WorkspaceError, WorkspaceExport, WorkspaceHistory, WorkspaceInfo,
