// Dial arithmetic (DESIGN.md §6). All of it is integer-Hz maths on a place-value view of the
...
/** Free-text entry (DESIGN.md §6). A unit suffix always wins; a bare number is megahertz,
