...
| **Denoise** | Spectral noise reduction. It tracks what each part of the spectrum does at its quietest and subtracts that. Anything genuinely unchanging counts as noise, including an unbroken carrier. |
